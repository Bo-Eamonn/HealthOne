                        ...
                        try{
                            ...
                            echo "</tr>";                       
                                ...
                                echo "<tr>";    
                                    ...
                                    echo "<td id='" . $data["insured"]."'>" . "<a title='Edit' href='editMed.php?id=" . $data['id'] . "'><i class='fa fa-pen' aria-hidden='true'></i></a>
                                                                               <a title='Delete' href='editMed.php?id=" . $data['id'] . "'><i class='fa fa-trash' aria-hidden='true'></i></a>" . " </td>";
                                echo "</tr>";
                            }
                            echo "</table>";     
